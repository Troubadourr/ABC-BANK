...
def giris_yap():
    ...
    def sifremi_unuttum():
        ...
        pencere_sifre.geometry("300x350")
        pencere_sifre.configure(bg="#E3F2FD")
        pencere.iconbitmap(r"C:\Users\ardaa\Desktop\ADVANCED PHYTON PROJESİ\b_abc_bank_logo.ico")

        tk.Label(pencere_sifre, text="Kullanıcı ID:", bg="#E3F2FD", font=("Segoe UI", 10, "bold")).pack()
        entry_id = tk.Entry(pencere_sifre)
        entry_id.pack()
        ...
        def sifre_degistir():
            ...
            if not kid or not ad or not soyad or not son4 or not yeni_sifre:
                messagebox.showerror("Hata", "Lütfen tüm alanları doldurun.")
                return

            if kid not in kullanicilar:
                messagebox.showerror("Hata", "Kullanıcı ID bulunamadı.")
                return
            ...
            if (
                ...
                messagebox.showerror("Hata", "Bilgiler eşleşmedi.")
